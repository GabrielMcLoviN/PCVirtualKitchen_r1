export const data = {
  scenes: [
      ...
      infoHotspots: [
        {
          ...
          subhead: '',
          fullWidth: true,
          text: "<iframe loading='lazy' allowfullscreen style='border:none;width:100%;height:100%;' src='//e.issuu.com/embed.html?d=p30530-012021usca-eat-well-ebook&hideIssuuLogo=true&hideShareButton=true&u=pamperedchef'></iframe>",
        },
        {
...

    {
      ...
      linkHotspots: [
        {
          yaw: -0.7501987811746767,
          pitch: 0.15245930885540346,
